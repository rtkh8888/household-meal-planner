...
- [ ] User can create combo with multiple dishes.
- [ ] User cannot create combo without name.
- [ ] User cannot create combo with zero dishes.
- [ ] User can edit combo name.
- [ ] User can add dish to existing combo.
- [ ] User can remove dish from existing combo.
